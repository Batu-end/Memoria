        ...
        return Button {
            ...
            .overlay(
                RoundedRectangle(cornerRadius: 8)
                    .stroke(
                        isSelected ? Color.white.opacity(0.5) : (isToday ? Color(red: 0.92, green: 0.81, blue: 0.42).opacity(0.6) : Color.white.opacity(0.04)), 
                        lineWidth: isSelected ? 1.5 : (isToday ? 0.75 : 0.5)
                    )
            )
